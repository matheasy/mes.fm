...
switch($uri) {
	case '/': //homepage
		echo $twig->render('calculator.twig', array(
			'gplus_author' => '',
			'page_description' => 'Master the craft of speed reading! By staring at one spot instead of scanning sentences from left to right, your eyes can read words at a higher rate. Slowly increase the words per minute value as you get faster and faster at reading. Can you reach the 1000 words per minute mark?',
		));
		break;
