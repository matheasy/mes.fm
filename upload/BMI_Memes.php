...
<body>
	...
	<table id="myTable">
		<tr>
			...
			<th>ID</th>
			<th>MEME LINK</th>
			<th>UPLOAD TYPE (1=memes, 2=health tips)</th>
		</tr>
		...
		while($row = mysqli_fetch_array($result)) {
		  ...
		  '<td><div><img src = "https://bmicalculator.mes.fm/img/memes-thumbnail/'.$row['thumbnailurl2'].'" /></td>'.
		  '<td>'.$row['thumbnailurl2'].'</td>'.
		  '<td>'.$row['id'].'</td>'.
		  '<td><a href="https://bmicalculator.mes.fm/'.($row['uploadtype']=='1'?'memes':'health-tips').'/'.$row['urlname'].'" target="_blank">https://bmicalculator.mes.fm/'.($row['uploadtype']=='1'?'memes':'health-tips').'/'.$row['urlname'].'</a></td>'.
