...
is a tile hub like `mes.fm/math` (10 icon tiles + an "Important Links" list) and emits **eleven** pages -- the hub plus
...
hutchison-interviews,cold-fusion-lenr,hutchison-livestreams}/index.html`, one section each (Grid View / List View, "← Hutchison Effect"
