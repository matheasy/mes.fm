...
// Output layout: mes.fm/math is a tile hub (one icon tile per section, each
// linking to its own page); each section then lives at mes.fm/<slug> with the
// Grid View / List View toggle. `hub` marks the tile page; every other entry
// renders exactly one SECTIONS entry (matched by sectionId).
const HUB_DESCRIPTION =
  "Free math video/article tutorials on infinite sequences and series, vectors and the geometry of space, vector functions, spherical harmonics, and more.";

const PAGES = [
  {
    slug: "math-qa",
    sectionId: "mathQaLivestreams",
    tileLabel: "MES Math Q/A Livestreams",
    description:
      "Replays, notes and stats from the MES Math Q/A livestreams: math and physics questions answered live, from the Lorentz force to the conservation of angular momentum.",
  },
  {
    slug: "cubic-formula",
    // Own build: mes.fm/cubic-formula/build.mjs mirrors the Hive article and its
    // 8 supporting video pages (a Problems-Plus-style page, not a link section).
    // This entry only supplies the hub tile -- no page is written for it here.
    ownBuild: true,
    tileLabel: "Cubic Formula Proof",
    description: "A complete video proof of the cubic formula, with written notes.",
  },
  {
    slug: "sequences-series",
    sectionId: "infiniteSequence",
    tileLabel: "Infinite Sequences and Series",
    description:
      "Video and written tutorials on infinite sequences and series: limits, convergence tests, power series, Taylor and Maclaurin series, and more.",
  },
  {
  ...
  },
  {
    slug: "vectors",
    sectionId: "vectors",
    tileLabel: "Vectors and the Geometry of Space",
    description:
      "Video and written tutorials on vectors and the geometry of space: 3D coordinates, dot and cross products, lines and planes, quadric surfaces, and more.",
  },
  {
    slug: "vector-functions",
    sectionId: "vectorfunctions",
    tileLabel: "Vector Functions",
    description:
...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { href: "https://mes.fm/math-qa-68-faraday-flux-rule", title: "68: What is Faraday's Flux Rule?" },
      { href: "https://mes.fm/math-qa-67-faraday-law", title: "67: What is Faraday's Law?" },
      { href: "https://mes.fm/math-qa-66-gauss-laws-electricity-magnetism", title: "66: What are Gauss's Laws for Electricity and Magnetism?" },
      { href: "https://mes.fm/math-qa-65-maxwell-equations", title: "65: What are Maxwell's Equations?" },
      { href: "https://mes.fm/math-qa-64-electromagnetic-potentials", title: "64: What are Electromagnetic Potentials?" },
      { href: "https://mes.fm/math-qa-63-aharonov-bohm-effect", title: "63: What is the Aharonov-Bohm Effect?" },
      { href: "https://mes.fm/math-qa-62-electrolysis", title: "62: What is Electrolysis?" },
      { href: "https://mes.fm/math-qa-61-hologram", title: "61: What is a Hologram?" },
      { href: "https://mes.fm/math-qa-60-brewster-polarization-angle", title: "60: What is the Brewster's (Polarization) Angle?" },
      { href: "https://mes.fm/math-qa-59-polarization-of-waves", title: "59: What is Polarization of Waves?" },
      { href: "https://mes.fm/math-qa-58-stellar-aberration", title: "58: What is Stellar Aberration?" },
      { href: "https://mes.fm/math-qa-57-michelson-morley-experiment", title: "57: What is the Michelson–Morley Experiment?" },
      { href: "https://mes.fm/math-qa-56-ionel-dinu-theory-of-aether", title: "56: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-55-ionel-dinu-theory-of-aether", title: "55: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-54-ionel-dinu-theory-of-aether", title: "54: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-53-ionel-dinu-theory-of-aether", title: "53: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-52-ionel-dinu-theory-of-aether", title: "52: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-51-ionel-dinu-theory-of-aether", title: "51: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-50-ionel-dinu-theory-of-aether", title: "50: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-49-ionel-dinu-theory-of-aether", title: "49: Ionel Dinu's Theory of Aether" },
      { href: "https://mes.fm/math-qa-48-photon", title: "48: What is a Photon?" },
      { href: "https://mes.fm/math-qa-47-fractalwoman-channel", title: "47: What Happened to FractalWoman's Channel?!" },
      { href: "https://mes.fm/math-qa-46-moray-device", title: "46: What is a Moray Device?" },
      { href: "https://mes.fm/math-qa-45-vacuum-tube", title: "45: What is a Vacuum Tube?" },
      { href: "https://mes.fm/math-qa-44-planck-length", title: "44: What is the Planck Length?" },
      { href: "https://mes.fm/math-qa-43-radio-waves", title: "43: What are Radio Waves?" },
      { href: "https://mes.fm/math-qa-42-lidar", title: "42: What is LiDAR?" },
      { href: "https://mes.fm/math-qa-41-back-emf", title: "41: What is Back EMF?" },
      { href: "https://mes.fm/math-qa-40-coral-castle", title: "40: How was Coral Castle Built?" },
      { href: "https://mes.fm/math-qa-39-magnetic-poles", title: "39: What are Magnetic Poles?" },
      { href: "https://mes.fm/math-qa-38-faraday-cage", title: "38: What is a Faraday Cage?" },
      { href: "https://mes.fm/math-qa-37-vortex-math", title: "37: What is Vortex Math?" },
      { href: "https://mes.fm/math-qa-36-atomic-bomb", title: "36: What is an Atomic Bomb?" },
      { href: "https://mes.fm/math-qa-35-thermite", title: "35: What is Thermite?" },
      { href: "https://mes.fm/math-qa-34-plane-590-mph-steel-columns", title: "34: Can a Plane going 590 mph Slice Through Steel Columns?" },
      { href: "https://mes.fm/math-qa-33-antimatter", title: "33: What is Antimatter?" },
      { href: "https://mes.fm/math-qa-32-joule-thief", title: "32: How Does a Joule Thief Work?" },
      { href: "https://mes.fm/math-qa-31-potentiometer-moon-landing-evidence", title: "31: What is a Potentiometer? (and Moon Landing Evidence)" },
      { href: "https://mes.fm/math-qa-30-bedini-motor", title: "30: What is the Bedini Motor?" },
      { href: "https://mes.fm/math-qa-29-magnets-attract-repel", title: "29: Why do Magnets Attract or Repel?" },
      { href: "https://mes.fm/math-qa-28-plasmoid", title: "28: What is a Plasmoid?" },
      { href: "https://mes.fm/math-qa-27-ball-lightning", title: "27: What is Ball Lightning?" },
      { href: "https://mes.fm/math-qa-26-consciousness", title: "26: What is Consciousness?" },
      { href: "https://mes.fm/math-qa-25-stern-gerlach-experiment", title: "25: What is the Stern-Gerlach Experiment" },
      { href: "https://mes.fm/math-qa-24-plane-tires-crash-explosion", title: "24: Can Plane Tires Survive a Plane Crash Explosion?" },
      { href: "https://mes.fm/math-qa-23-grand-unified-theory", title: "23: What is a Grand Unified Theory?" },
      { href: "https://mes.fm/math-qa-22-focus-fusion", title: "22: What is Focus Fusion?" },
      { href: "https://mes.fm/math-qa-21-shape-of-the-earth", title: "21: What Shape is the Earth?" },
      { href: "https://mes.fm/math-qa-20-aether", title: "20: What is the Aether?" },
      { href: "https://mes.fm/math-qa-19-magnetic-mirror", title: "19: What is a Magnetic Mirror?" },
      { href: "https://mes.fm/math-qa-18-atwood-machine", title: "18: What is the Atwood Machine?" },
      { href: "https://mes.fm/math-qa-17-lunar-regolith-moon-dust", title: "17: What is Lunar Regolith (Moon Dust)?" },
      { href: "https://mes.fm/math-qa-16-van-allen-radiation-belts", title: "16: What are the Van Allen Radiations Belts?" },
      { href: "https://mes.fm/math-qa-15-cold-fusion", title: "15: What is Cold Fusion?" },
      { href: "https://mes.fm/math-qa-14-nasa-apollo-photos-composites", title: "14: Are NASA Apollo photos composites?" },
      { href: "https://mes.fm/math-qa-13-inertial-propulsion", title: "13: What is Inertial Propulsion?" },
      { href: "https://mes.fm/math-qa-12-building-demolition-types", title: "12: What types of Building Demolitions are there?" },
      { href: "https://mes.fm/math-qa-11-tesla-coil", title: "11: How does a Tesla Coil work?" },
      { href: "https://mes.fm/math-qa-10-gravity", title: "10: What is Gravity?" },
      { href: "https://mes.fm/math-qa-9-opposing-magnets-fall-slower-than-gravity", title: "9: Do opposing magnets fall SLOWER than gravity?" },
      { href: "https://mes.fm/math-qa-8-high-frequency-radio-waves", title: "8: What are High Frequency Radio Waves?" },
      { href: "https://mes.fm/math-qa-7-crop-circles", title: "7: How are Crop Circles Formed?" },
      { href: "https://mes.fm/math-qa-6-hutchison-effect-lab-equipment", title: "6: What Lab Equipment is Needed for the Hutchison Effect?" },
      { href: "https://mes.fm/math-qa-5-hutchison-effect", title: "5: How does the Hutchison Effect work?" },
      { href: "https://mes.fm/math-qa-4-free-energy-device-claims", title: "4: Analyzing Free Energy Device Claims" },
      { href: "https://mes.fm/math-qa-3-how-ai-works", title: "3: How does AI work?" },
      { href: "https://mes.fm/math-qa-2-hurricanes", title: "2: How are Hurricanes Formed?" },
      { href: "https://mes.fm/math-qa-1-special-birthday-stream", title: "1: Special Birthday Stream" },
    ],
  },
  {
    id: "infiniteSequence",
...
function buildPage(meta, page) {
  ...
  const pageTitle = isHub ? "Math Tutorials" : page.tileLabel;
  const description = isHub ? HUB_DESCRIPTION : page.description;
  const ogImage = isHub ? "https://mes.fm/img/logo-big.png" : `https://mes.fm/img/${page.slug}-icon.jpg`;
  const breadcrumbHtml = isHub
    ? ""
    : `<p class="page-breadcrumb"><a href="/math">&larr; Math Tutorials</a></p>\n        `;
...
/* Hub page (mes.fm/math): one icon tile per section, label overlaid as real
...
async function main() {
  ...
  const pages = [{ hub: true, slug: "math", outDir: __dirname }].concat(
    PAGES.map((p) => ({ ...p, outDir: join(__dirname, "..", p.slug) }))
  );
  for (const page of pages) {
    if (page.ownBuild) continue; // generated by its own build.mjs (see PAGES)
