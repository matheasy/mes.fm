...
<body>
	...
	<p>INFLATION CALCULATOR MEMES</p>
	...
	<table id="myTable">
		...
		while($row = mysqli_fetch_array($result)) {
		  ...
		  '<img src = "https://inflationcalculator.mes.fm/img/memes-thumbnail/'.$row['thumbnailurl2'].'" /></td>'.
		  '<td>'.$row['thumbnailurl2'].'</td>'.
		  '<td>'.$row['id'].'</td>'.
		  '<td><a href="https://inflationcalculator.mes.fm/inflation-facts/'.$row['urlname'].'" target="_blank">https://inflationcalculator.mes.fm/inflation-facts/'.$row['urlname'].'</a></td>'.
