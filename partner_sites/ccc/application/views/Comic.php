...
<section id="intro">
									<div>
										<div class="row">
											<div class="2u">
												<section class="first">
												<a href="/<?php echo $latestUrl?>">Latest</a>
												</section>
											</div>
											<div class="2u">
												<section class="first">
													<a id="prev_url"  title="Shortcut: Left Arrow" href="<?php echo $prevUrl?>">Prev</a>
												</section>
											</div>
											<div class="2u">
											...
											<div class="2u">
												<section class="last">
													<a id="next_url"  title="Shortcut: Right Arrow" href="<?php echo $nextUrl?>">Next</a>
												</section>
											</div>
											<div class="2u">
												<section class="last">
...
<section id="banner">
	...
	<a href="<?php echo '/media/comics/full/', $comic_url; ?>">
...
<div class="facebook-comment">
	<div class="fb-comments" data-href="<?php echo $_SERVER['SERVER_NAME'] ."/archives/archive". $_SERVER['REQUEST_URI'] ?>" data-numposts="5" data-colorscheme="light"></div>
</div>
<!--<div class="right-ad">
