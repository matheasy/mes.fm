...
<html>
	<head>
		<title>Privacy Policy | Chin Chat Comics</title>
					...
					<div id = "page-content">
						<div id="inner-content">
							...
							<div id="main-content">
								...
								<p>
								This Privacy Policy governs the manner in which Chin Chat Comics collects, uses, maintains and
								discloses information collected from users (each, a "User") of the chinchatcomics.mes.fm website
								("Site"). This privacy policy applies to the Site and all products and services offered by Chin Chat Comics.
								</p>
								...
								<p>
								Chin Chat Comics may collect and use Users personal information for the following purposes:
								</p>
								
								<p class="italic">
								- To improve customer service
								</p>
								<p class="small-margin">Information you provide helps us respond to your customer service requests and support needs more efficiently.</p>
								...
								<p class="small-margin">To send Users information they agreed to receive about topics we think will be of interest to them.</p>
								...
								<p>
								Chin Chat Comics has the discretion to update this privacy policy at any time. When we do, we will
								...
								with this site, please contact us at: contact@mes.fm
								</p>
								
								<p>
								This document was last updated on January 11, 2017
								</p>
